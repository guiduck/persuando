...
- `node --test apps/api/test/auth.test.mjs` passed with 6 auth tests, including single-use login bridge coverage and API-local Capture auth completion coverage.
