...
- `npm.cmd run test` passed with 105 passing tests, including provider coverage that Code Practice requests Markdown, detected-language snippets, fenced code blocks, and a JavaScript fallback when the language is unclear.
